...
<header class="app-header">
  ...
  <nav class="nav-tabs" id="navTabs">
    ...
    <!-- 技術DNA -->
    <div class="nav-group">
      <button class="nav-group-btn">🧬 技術DNA <span class="nav-arrow">▾</span></button>
      <div class="nav-dropdown">
...
<div class="footer">
  資料來源: TWSE (t187ap14_L/17_L/05_L/BWIBBU_ALL/MI_MARGN) + TPEX (t187ap14_O/06_O_ci/05_O) &nbsp;|&nbsp;
...
async function openVegasChart(code) {{
  ...
  try {{
    const url = '/api/yahoo_chart?code=' + code;
